...
const Footer = () => {
  return (
    <footer className="border-t border-gray-200 py-4 sm:py-6 px-2 sm:px-4 mt-6 sm:mt-10">
      <div className="container mx-auto flex flex-col space-y-4 sm:space-y-6 lg:space-y-0 lg:flex-row justify-between items-center">
        {/* Logo Section */}
        ...
        <div className="text-xs text-gray-600 text-center lg:text-left max-w-full px-2 sm:px-4">
          ...
          <div className="flex flex-wrap justify-center lg:justify-start gap-[5px] mb-2">
            <Link 
              href="https://my.apex-social.com" 
              className="font-inter text-black text-[10px] sm:text-[12px] font-medium whitespace-nowrap"
            >
              my.apex-social.com
            </Link>
            <span className="font-inter text-black text-[10px] sm:text-[12px] font-medium whitespace-nowrap">
              - powered by A.P.EX. American Professional Exchange, LLC. |
            </span>
            <Link 
              href="/career" 
              className="hover:underline font-inter text-black text-[10px] sm:text-[12px] font-medium whitespace-nowrap"
            >
              Career
            </Link>
